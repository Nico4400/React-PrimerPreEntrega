...
const Cart = ({id, producto, imagen, precio, stock, categoria, marca, descripcion }) => (
    <Card
      style={{
        width: 400,        
      }}
      ...
      actions={[
          <Contador initial={1} stock={stock} onAdd={(contador) => console.log(`Cantidad agregada ${contador} y ${id}`)}/>
      ]}
    >
